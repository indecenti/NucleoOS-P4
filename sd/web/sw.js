...
self.addEventListener('fetch', (e) => {
  ...
  if (p.startsWith('/api/')) {
    ...
    // gira ESCLUSIVA (prende tutti i permessi): il dispositivo la serve da sola, con tutto l'heap
