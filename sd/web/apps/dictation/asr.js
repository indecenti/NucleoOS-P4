...
// browser. The device's PDM mic is streamed as raw PCM over /api/rec/stream
...
import { streamMic } from '/micgate.js';   // OS-wide single-owner gate for the device mic
...
export function createASR() {
  ...
  // back to the SD copy (whole file, then split parts) served by the device.
