// Vendored from WASM-4 (https://github.com/aduros/wasm4, cli/assets/templates/c/src, commit 9d6c962785cf).
// Copyright (c) Bruno Garcia, ISC license (components/nv_wasm/w4/LICENSE).
//
