...
3. Make sure it builds (`idf.py build`, ESP-IDF v5.5.2, target `esp32p4`).
4. Open a pull request describing **what** changed and **why**.

## Contributor License Agreement (important)

NucleoOS P4 is offered under a **dual model**: free under the
[PolyForm Noncommercial License](LICENSE.md), and under separate **paid commercial licenses**
...
- You grant **indecenti** (the maintainer) a perpetual, worldwide, non-exclusive,
  ...
  **relicense** your contribution, **including under commercial terms**, as part of NucleoOS P4.
...
dependencies must be noted in [THIRD_PARTY.md](THIRD_PARTY.md) with their license.
